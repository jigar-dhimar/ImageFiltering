...
function makeCircle(c,w,h,sliderVal,string){
    ...
    filterAngle(c,w,h,sliderVal,string);
}

function setStepVal(new_value) {
    step = new_value;
    makeCircle(c1,w1,h1,sliderVal1,"cb1");
    makeCircle(c2,w2,h2,sliderVal2,"cb2");
    makeCircle(c3,w3,h3,sliderVal3,"cb3");
}
...
function drawFilteredImg() {
    if( document.getElementById("cb1").checked ) {
        filterAngle(c1,w1,h1,sliderVal1,"cb1");
        Hsv_array[i++] = lowerB;
        Hsv_array[i++] = upperB;
    }

    if( document.getElementById("cb2").checked ) {
        filterAngle(c2,w2,h2,sliderVal2,"cb2");
        Hsv_array[i++] = lowerB;
        Hsv_array[i++] = upperB;
    }

    if( document.getElementById("cb3").checked ) {
        filterAngle(c3,w3,h3,sliderVal3,"cb3");
        Hsv_array[i++] = lowerB;
        Hsv_array[i++] = upperB;
    }
    i = 0;
